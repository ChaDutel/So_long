...
/*   Updated: 2022/05/21 17:30:54 by cdutel-l         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_convert_imgs(t_game *game)
{
	game->img_floor = mlx_xpm_file_to_image(game->mlx, \
		"./sets/floor.xpm", &game->img_lenght, &game->img_height);
	game->img_wall = mlx_xpm_file_to_image(game->mlx, \
		"./sets/wall.xpm", &game->img_lenght, &game->img_height);
	game->img_collectible = mlx_xpm_file_to_image(game->mlx, \
		"./sets/collectible.xpm", &game->img_lenght, &game->img_height);
	game->img_player = mlx_xpm_file_to_image(game->mlx, \
		"./sets/player_peasant.xpm", &game->img_lenght, &game->img_height);
	game->img_exits = mlx_xpm_file_to_image(game->mlx, \
		"./sets/exit-tp.xpm", &game->img_lenght, &game->img_height);
}
