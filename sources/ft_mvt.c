...
/*   Updated: 2022/05/21 17:27:55 by cdutel-l         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_mvt(int key_code, t_game *game)
{
	...
	if (game->collectible == 0)
	{
		...
		game->img_player = mlx_xpm_file_to_image(game->mlx, \
			"./sets/player_mega.xpm", &game->img_lenght, &game->img_height);
		ft_put_imgs(game, game->img_player, game->player_x, game->player_y);
		ft_put_exits(game);
	}
	return (0);
}
